...
-- Thời gian đã tạo: Th10 09, 2018 lúc 03:12 AM
...
(12, 'OPPO F7 128GB', 'oppo-f7-128gb-den-400x460.png', 'smart', 5467546, 345, 6000000),
(13, ' OPPO F9 6GB', 'oppo-f9-6gb-red-docquyen-400x460.png', 'Là chiếc điện thoại OPPO được nâng cấp cấu hình, cụ thể là RAM lên tới 6 GB, OPPO F9 6GB còn trang bị nhiều tính năng đột phá như sở hữu công nghệ sạc VOOC mới nhất, mặt lưng chuyển màu độc đáo, màn hình tràn viền giọt nước và camera chụp chân dung tích hợp trí tuệ nhân tạo A.I hoàn hảo.', 23423423, 345, 1500000),
(14, 'OPPO F9 Tím Tinh Tú\r\n', 'oppo-f9-tim-doc-quyen-400x460.png', 'Là chiếc điện thoại OPPO sở hữu một sắc tím đẹp đến mê người và không còn đi theo phong cách đơn thuần một màu sắc, OPPO F9 Tím Tinh Tú điểm trên mặt lưng những ánh kim tuyến độc đáo và màn hình giọt nước siêu tràn viền.', 25235, 345, 17000000),
(15, ' OPPO A71k (2018)', 'oppo-a71-mau-xanh-2018-1-1-400x460.png', 'Phiên bản OPPO A71k (2018) ra mắt với vi xử lý Snapdragon 450 mạnh mẽ hơn, chụp ảnh selfie làm đẹp bằng AI thông minh và giá rẻ hơn, đổi lại bộ nhớ RAM giảm xuống còn 2 GB.', 235235, 345, 18000000),
(16, 'Huawei P20 Pro', 'huawei-p20-pro-h1-400x460.png', 'Thiết kế tai thỏ thời thượng, cấu hình khủng và đặc biệt nhất là bộ 3 camera là những gì mà người ta ấn tượng kể từ khi chiếc điện thoại Huawei P20 Pro ra mắt.', 563456345, 456, 800000),
(17, ' Huawei Nova 3', 'huawei-nova-3-purple-400x460.png', 'Nếu như bạn là một người yêu thích thiết kế của siêu phẩm Huawei P20 Pro nhưng cần một mức giá dễ chịu hơn thì Huawei Nova 3 sẽ là một sự lựa chọn phải chăng dành cho bạn.', 345646, 456, 1500000),
(18, 'Huawei Nova 3i', 'huawei-nova-3i-den-chipu-1-400x460.png', 'Với những smartphone như Nova 2i hay Nova 3e thì Huawei đã và đang tạo nên những cơn sốt rất lớn trong phân khúc tầm trung và cái tên mới Huawei Nova 3i được cải tiến và nâng cấp nhiều điểm mới, hứa hẹn sẽ mang lại làn gió mới cho thị trường.', 53453, 456, 2000000),
(19, 'Huawei Nova 3i Trắng\r\n', 'huawei-nova-3i-trang-400x460.png', 'Là chiếc điện thoại sở hữu gam màu nhẹ nhàng, Huawei Nova 3i Trắng đem lại sự thanh lịch, quý phải so với phiên bản xanh tím độc đáo hay sắc đen sang trọng', 3456346, 456, 14000000),
(20, 'Huawei Y7 Pro (2018)', 'huawei-y7-pro-2018-400x460.png', 'Huawei Y7 Pro (2018) là sản phẩm tầm trung với đầy đủ những trang bị của một chiếc smartphone theo xu thế của năm 2018.', 123123, 456, 4000000),
(21, 'Xiaomi Mi A2', 'xiaomi-mi-a2-2-400x460.png', 'Tiếp nối sự thành công của Xiaomi Mi A1 thì Xiaomi tiếp tục giới thiệu tới người dùng phiên bản kế nhiệm là chiếc Xiaomi Mi A2 với nâng cấp mạnh mẽ về cấu hình cũng như camera.', 75345, 567, 1500000),
(22, ' Xiaomi Redmi Note 5', 'xiaomi-redmi-note-5-pro-400x460.png', 'Xiaomi Redmi Note 5 là smartphone thứ ba trong phân khúc tầm trung - giá rẻ của Xiaomi sở hữu màn hình tỉ lệ mới 18:9.', 234234236, 567, 10000000),
